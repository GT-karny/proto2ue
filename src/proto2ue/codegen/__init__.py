...
class DefaultTemplateRenderer:
    ...
    def render(self, ue_file: UEProtoFile) -> Iterable[GeneratedFile]:
        ...
        source_content = self._render_source(header_name, ue_file)
        return [
    ...
    def _render_source(self, header_name: str, ue_file: UEProtoFile) -> str:
        lines: List[str] = []
        lines.append(f"// Generated by proto2ue. Source: {ue_file.name}")
        ...
        lines.append(f"{indent}    void RegisterGeneratedTypes() {{}}");
        lines.append(f"{indent}}}  // namespace proto2ue")
